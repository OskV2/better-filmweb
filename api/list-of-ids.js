import { getNumberOfItems } from './request-details.js';

// * About this function:
// @param cookie - accepts session cookie as a parameter
...
export const getListOfIDs = async (cookie, mediaCategory, mediaType) => {
